...
IUSE="bindist clang cpu_flags_x86_avx2 dbus debug eme-free geckodriver
	...
	+openh264 pgo pulseaudio selinux +system-av1
...
PATCH_URIS=( https://dev.gentoo.org/~anarchy/mozilla/patchsets/${PATCH}.tar.xz )
SRC_URI="${SRC_URI}
	${MOZ_SRC_URI}
	${PATCH_URIS[@]}"
...
pkg_setup() {
	...
	# Use system python instead of depending on mozilla's virtualenv
