...
# $Header: /var/cvsroot/gentoo-x86/www-client/epiphany/epiphany-2.26.3.ebuild,v 1.1 2009/07/06 22:08:22 eva Exp $
...
src_prepare() {
	...
	# Fix nsplugin location to use system
	epatch "${FILESDIR}/${PN}-2.26.3-nsplugin.patch"
